...
module.exports = function(fn) {
  async.auto({
    ...
    read_buffer_to_string: ['get_stats', 'open_file', function(results, callback) {
    ...
    get_single_word: ['read_buffer_to_string', function(results, callback) {
      ...
      // trim any special chars
      word = String(word).replace("\r", "");
      callback(null, word);
    }]
